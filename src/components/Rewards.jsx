    ...
    return (
        <div className='md:h-screen  xs:h-[700px] bg-blue-50  h-screen relative'>
            ...
            {isloading ? <div className='flex flex-col justify-center items-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                ...
                <div className='text-sm text-[#16a4ba]'>Loading...</div>
            </div> : <>
                ...
                <div className="flex flex-col items-center w-full">
                    <div className='text-[#d28c3e] text-4xl font-black flex flex-col items-center text_outline mt-4 text-bold text-center w-full'>
                        <div>Simple three steps</div>
                        <div>invite friends</div>
                    </div>

                    <div className='text-[#853d34] text-3xl flex flex-col items-center font-extrabold mt-4 text-bold text-center w-full'>
                        Enjoy 10% dividend
                    </div>

                    <div className="flex flex-col items-center translate-y-5  bg-[#ff8603] p-3 w-[85%] mx-auto text-white text-lg font-bold rounded-lg shadow-orange-500 shadow-md">
                    ...
                    <div className="flex flex-col gap-4 px-2 bg-white rounded-lg shadow-lg w-[98%] mx-auto border border-gray-400">
                        ...
                        <div className="flex items-center gap-1 border-b border-gray-300 py-2">
                            ...
                            <div className="w-8/12 flex flex-col text-sm">
                                <div className='font-semibold text-md'>Invitation 3 Friends spend &#8377; 500</div>
                        ...
                        <div className="flex items-center gap-1 border-b border-gray-300 py-2">
                            ...
                            <div className="w-8/12 flex flex-col text-sm">
                                <div className='font-semibold text-md'>Invitation 5 Friends spend &#8377; 500</div>
                                <div className='flex gap-1 items-center'>
                        ...
                        <div className="flex items-center gap-1 border-b border-gray-300 py-2">
                            ...
                            <div className="w-8/12 flex flex-col text-sm">
                                <div className='font-semibold text-md'>Invitation 10 Friends spend &#8377; 500</div>
                                <div className='flex gap-1 items-center'>
                        ...
                        <div className="flex items-center gap-1 border-b border-gray-300 py-2">
                            ...
                            <div className="w-8/12 flex flex-col text-sm">
                                <div className='font-semibold text-md'>Invitation 30 Friends spend &#8377; 500</div>
                                <div className='flex gap-1 items-center'>
                        ...
                        <div className="flex items-center gap-1 border-b border-gray-300 py-2">
                            ...
                            <div className="w-8/12 flex flex-col text-sm">
                                <div className='font-semibold text-md'>Invitation 60 Friends spend &#8377; 500</div>
                                <div className='flex gap-1 items-center'>
                    ...
                    <div className="flex w-[98%] flex-col font-bold border bg-white border-gray-300 shadow-lg mt-2 rounded-lg mx-auto p-3 gap-2">
                        <div className='text-lg text-[#16a4ba]'>*Enter the Lifafa code to get today's rewards</div>
                        ...
                        <button onClick={getReward2} className='bg-[#16a4ba] p-3 text-white shadow-md rounded-md '>Redeem Code</button>
                    </div>
                </div>
            </>}
