...
const Recharge = () => {
    ...
    return (
        <div className='bg-[#f7f9f8] h-screen relative'>
            ...
            <div className="options text-center flex items-center bg-[#16a4ba] text-white text-md p-3 font-normal mb-4">
            ...
            <div className="box gap-2 flex flex-col text-gray-500 p-2 font-semibold bg-[#fafff9] rounded-xl  shadow-xl m-4 border border-gray-300">
                ...
                <div className='m-1 text-md font-bold  text-[#16a4ba]'>Recharge Amount:</div>
                <div className=' flex items-center bg-[#e0e5e1] p-1 m-2 rounded-lg'>
                    <span className='text-[#16a4ba] font-bold p-0.5 pr-1 mr-1 py-1'>INR</span>
                    <input onChange={(e) => setRecharge_Value(e.target.value)} type="text" name="amount" id="amt" placeholder='Amount' 
                    className='w-full bg-inherit outline-none text-[#16a4ba] py-1  font-normal text-lg' />
                </div>
            ...
            <div className="cnf_recharge w-4/5 mx-auto mt-10">
                <button onClick={handleRecharge} className='w-full bg-[#16a4ba] py-2 rounded-md text-white text-lg shadow-customShadow shadow-[#beadcc]'>Confirm Recharge</button>
            </div>
        </div>
    )
}
