...
const Record = () => {
    ...
    return (
        <div className=' bg-[#f7f9f8] pb-3 sm:h-[1000px] md:h-screen h-screen'>
            ...
            <div className='records w-full flex bg-[#10a6b7] items-center text-sm'>
                        ...
                        <div key={id} className='custom_card mt-3 bg-[#ffffff] mx-auto w-full flex flex-col items-center p-2 shadow-2xl border border-gray-300 rounded-xl'>
                            <div className='flex justify-between items-center w-full'>
                                <div className='flex flex-col gap-1'>
                                    <div className='text-[#16a4ba] text-md overflow-clip'><span className='font-bold text-gray-500'>Recharge Value:</span> &#8377;{new Intl.NumberFormat().format(element.recharge_value)}</div>
                                    <div className='text-[#16a4ba] text-md overflow-clip'><span className='font-bold text-gray-500'>Ref No:</span> {element.refno}</div>
