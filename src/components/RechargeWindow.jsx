...
const RechargeWindow = () => {
    ...
    return (
        <div className='sm:h-[700px] md:h-[950px] flex flex-col gap-4  bg-[#F2F2F2] relative'>
            ...
            <div className="options text-center text-white flex gap-2 items-center p-2  bg-[#16a4ba] text-lg pt-2 font-medium">
            ...
            <div className='flex flex-col gap-4 p-8'>
                ...
                <div className='font-bold text-xl text-[#16a4ba]'>UPI Information</div>
                <div className="box flex rounded-lg p-6 flex-col mt-3 bg-[#16a4ba] text-white">
                    <div className='text-md'>Payment Amount</div>
                    <div className='text-4xl'>&#8377; {recharge_value}</div>
                </div>

                <div className='font-bold text-xl text-[#16a4ba]'>Payment Via UPI</div>
                <div className="step_one flex flex-col gap-1">
                    <div className='text-md'>1.Copy UPI information</div>
                    <div className='flex rounded-md items-center justify-between gap-2  p-2 border-2 border-[#16a4ba]'>
                        <div className='text-[#16a4ba] font-bold'>{amountDetails.upi_id}</div>
                        <CopyToClipboard text={`${amountDetails.upi_id}`} onCopy={() => toaster('Copied to clipboard')}>
                        <div className='text-lg font-bold text-[#16a4ba] cursor-pointer'>Copy</div>
                </CopyToClipboard>
                ...
                <div className='flex rounded-md justify-between gap-2 text-[#16a4ba]  p-2 border-2 border-[#16a4ba]'>
                ...
                <div className="small_info text-sm  underline text-[#16a4ba]">
                ...
                <button onClick={handleRecharge} className='bg-[#16a4ba] text-white p-4 rounded-lg text-lg shadow-lg shadow-gray-400'>Submit</button>
