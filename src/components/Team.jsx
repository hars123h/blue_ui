    ...
    <div className=''>
      ...
      <div className='flex flex-col items-center w-full'>
        ...
        <div className="flex items-center  w-[90%]">
          <div className='p-3 text-center text-lg w-1/3 rounded-t-lg border border-gray-300 shadow-cyan-400 shadow-lg text-cyan-400' onClick={e => setCurrentVisible('level1')}>Level 1</div>
          <div className='p-3 text-center text-lg w-1/3 rounded-t-lg border border-gray-300 shadow-cyan-400 shadow-lg text-cyan-400' onClick={e => setCurrentVisible('level2')}>Level 2</div>
