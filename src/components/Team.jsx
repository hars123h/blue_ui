...
const Team = () => {
  ...
  return (
    <div className=''>
      {/* [#2e9afe] */}
      <div className="top flex items-center my-auto text-center h-10 p-1 bg-blue-600 text-white text-lg font-medium">
      ...
      <div className='flex flex-col items-center w-full'>
        <div className='flex text-blue-600 font-semibold flex-col items-center w-[90%] border border-gray-300 text-lg p-3 m-3 shadow-lg shadow-blue-600 rounded-lg'>
        ...
        <div className="flex items-center  w-[90%]">
          <div className='p-3 text-center text-lg w-1/3 rounded-t-lg border border-gray-300 shadow-blue-600 shadow-lg text-blue-600' onClick={e => setCurrentVisible('level1')}>Level 1</div>
          <div className='p-3 text-center text-lg w-1/3 rounded-t-lg border border-gray-300 shadow-blue-600 shadow-lg text-blue-600' onClick={e => setCurrentVisible('level2')}>Level 2</div>
          <div className='p-3 text-center text-lg w-1/3 rounded-t-lg border border-gray-300 shadow-blue-600 shadow-lg text-blue-600' onClick={e => setCurrentVisible('level3')}>Level 3</div>
        </div>

        {currentVisible === 'level1'  && (
          <div className='flex text-blue-600 items-center font-semibold flex-col w-[90%] border border-gray-300 text-lg p-3 m-3 mt-0 shadow-lg shadow-blue-400 rounded-lg'>
            ...
            {level1.map((element, index) => {
              return (
                <div key={index} className='flex flex-row text-blue-600 font-semibold justify-between w-full border border-gray-300 text-lg p-3 m-3 shadow-lg shadow-gray-400 rounded-lg'>
                  <div>
