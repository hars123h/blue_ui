...
const ClientFeedback = () => {
    ...
    return (
        <div className=' bg-[#f7f9f8] h-screen flex flex-col text-white font-light relative'>
            ...
            <div className="top p-3 cursor-pointer flex bg-[#16a4ba]">
            ...
            <div className='box gap-3 flex flex-col text-gray-500 p-6 font-semibold bg-[#fafff9] rounded-xl  shadow-xl m-4 border border-gray-300'>
                <div className='w-full px-2 text-[#16a4ba] py-2 font-bold text-lg' > * Please enter the feedback details.</div>
                ...
                <div className="flex justify-center items-center">
                    <Button className='w-1/5' variant="contained" style={{ color: 'white', backgroundColor: '#14a5ba' }} onClick={handleSubmit}>Submit</Button>
                </div>
            </div>
        </div>
    )
