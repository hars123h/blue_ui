...
const Mine = () => {
  ...
  return (
    <div className='relative '>
      ...
      {/*Navigation Bar 2*/}
      <div className="fixed bottom-0 z-10 bg-[#12a6b4] rounded-none text-white flex overflow-x-hidden  mx-auto mt-2 border-2 border-gray-100 w-full overflow-y-hidden">
