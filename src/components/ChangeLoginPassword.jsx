...
//[#2e9afe]
    return (
        <div className='bg-[#f7f9f8] h-screen sm:h-[700px] md:h-[950px] relative'>
            ...
            <div className="options text-center flex bg-[#16a4ba] shadow-lg font-medium items-center p-3">
...
{/* [#61b2ff]  */}
            <div className="box flex gap-1 p-3 flex-col text-gray-500 font-semibold bg-[#fafff9] rounded-xl  shadow-xl m-4 border border-gray-300">
                ...
                <div className='flex  items-center text-[#16a4ba] text-md p-2'>
            ...
            <div className='flex'>
                ...
                className='bg-[#16a4ba] w-[90%] text-white text-lg mt-5 mb-20 rounded-lg mx-auto block py-2 shadow-md'>Confirm</button>
            </div>
        </div>
    )
}
